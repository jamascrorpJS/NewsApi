...
class SearcPaging(private val apiSources: ApiSources, private val id: String) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Model1> {
        try {
            ...
            val response = apiSources.getNewsSearch(id, currentList, "en", sizes, BuildConfig.API_KEY)
